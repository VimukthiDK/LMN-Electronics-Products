<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="customer.aspx.cs" Inherits="LMN_Electronics_Products.customer" %>
            ...
            <div id="layoutSidenav_content">
                <main>
                    <div class="container-fluid">
                        <h1 class="mt-4">LMN Electronics Customer </h1>
                        <ol class="breadcrumb mb-4">
                            <li class="breadcrumb-item active">Create And Edit Customer.</li>
                        </ol>
                        <div class="row">
