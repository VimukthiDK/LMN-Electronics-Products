<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="delivery_order.aspx.cs" Inherits="LMN_Electronics_Products.delivery_order" %>
            ...
            <div id="layoutSidenav_content">
                <main>
                    <div class="container-fluid">
                        <h1 class="mt-4">LMN Electronics Delivery Order </h1>
                        <ol class="breadcrumb mb-4">
                            <li class="breadcrumb-item active">View Deliver Orders.</li>
                        </ol>
                        <div class="row">
