<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="item.aspx.cs" Inherits="LMN_Electronics_Products.item" %>
            ...
            <div id="layoutSidenav_content">
                <main>
                    <div class="container-fluid">
                        <h1 class="mt-4">LMN Electronics Item </h1>
                        <ol class="breadcrumb mb-4">
                            <li class="breadcrumb-item active">Create And Edit Items.</li>
                        </ol>
                        <div class="row">
