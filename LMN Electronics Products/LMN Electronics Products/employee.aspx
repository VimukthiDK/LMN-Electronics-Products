<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="employee.aspx.cs" Inherits="LMN_Electronics_Products.employee" %>
            ...
            <div id="layoutSidenav_content">
                <main>
                    <div class="container-fluid">
                        <h1 class="mt-4">LMN Electronics Employee </h1>
                        <ol class="breadcrumb mb-4">
                            <li class="breadcrumb-item active">Create And Edit Employee.</li>
                        </ol>
                        <div class="row">
