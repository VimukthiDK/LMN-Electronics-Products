<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="product.aspx.cs" Inherits="LMN_Electronics_Products.product" %>
...
<html lang="en">
    ...
    <body class="sb-nav-fixed">
        <nav class="sb-topnav navbar navbar-expand navbar-dark bg-dark">
            <a class="navbar-brand" href="index.aspx">LMN Electronics  </a>
            ...
            <div id="layoutSidenav_content">
                <main>
                    <div class="container-fluid">
                        <h1 class="mt-4">LMN Electronics Product</h1>
                        ...
                        <div class="row">
                            ...
                            <asp:GridView ID="gv_product" runat="server" AutoGenerateColumns="false" ShowFooter="true" 
                                ...
                                <Columns>
                                    <asp:TemplateField HeaderText="Product ID">
                                        ...
                                        <EditItemTemplate>
                                            <asp:TextBox id="txtFirstId" Text='<%# Eval("Product_Id") %>' runat="server" />
                                        </EditItemTemplate>
                                        <FooterTemplate>
                                            <asp:TextBox id="txtFirstIdFooter" runat="server" />
                                        </FooterTemplate>
                                    </asp:TemplateField>
                                    ...
                                    <asp:TemplateField HeaderText="Product Name">
                                        ...
                                        <EditItemTemplate>
                                            <asp:TextBox id="txtFirstName" Text='<%# Eval("Product_Name") %>' runat="server" />
                                        </EditItemTemplate>
                                        <FooterTemplate>
                                    ...
                                    <asp:TemplateField>
                                        <ItemTemplate>
                                            <asp:ImageButton ImageUrl="~/img/edit.gif" runat="server" CommandName="Edit" ToolTip="Edit" width="20px" Height="20px" />
                                            <asp:ImageButton ImageUrl="~/img/delete.gif" runat="server" CommandName="Delete" ToolTip="Delete" width="20px" Height="20px" />
                                        </ItemTemplate>
                                        <EditItemTemplate>
                                             <asp:ImageButton ImageUrl="~/img/save.gif" runat="server" CommandName="Save" ToolTip="Save" width="20px" Height="20px"/>
                                             <asp:ImageButton ImageUrl="~/img/cancel.gif" runat="server" CommandName="Cancel" ToolTip="Cancel" width="20px" Height="20px" />
                                        </EditItemTemplate>
                                        <FooterTemplate>
                                             <asp:ImageButton ImageUrl="~/img/add.gif" runat="server" CommandName="AddNew" ToolTip="Add New" width="20px" Height="20px" />
                                        </FooterTemplate>
                                    </asp:TemplateField>
                                </Columns>
                            </asp:GridView>
