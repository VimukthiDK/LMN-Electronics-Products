<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="add_item.aspx.cs" Inherits="LMN_Electronics_Products.add_item" %>
            ...
            <div id="layoutSidenav_content">
                <main>
                    <div class="container-fluid">
                        <h1 class="mt-4">LMN Electronics Add Item </h1>
                        <ol class="breadcrumb mb-4">
                            <li class="breadcrumb-item active">Add New Item Stock.</li>
                        </ol>
                        <div class="row">
